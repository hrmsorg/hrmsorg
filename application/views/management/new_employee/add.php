...
<div class="x_panel">
    ...
    <div class="x_content">
                    ...
                    <div class="clearfix"></div>
    <?php echo form_open('NewEmployee/save_new_employee');?>
             <input type="hidden" name="id" id="id">
                ...
                <div class="item form-group">
                                                  ...
                                                  <div class="controls">
                                                      <div class="input-prepend input-group">
                                                        <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                          ...
                                                          <input type="text" class="form-control has-feedback-left" id="single_cal2" name="tgl_lamaran" placeholder="Tanggal Lamaran" >
                                                          <!-- <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                                          <span id="inputSuccess2Status3" class="sr-only">(success)</span> -->
                                                      </div>
                                                  </div>
                 ...
                 <div class="clearfix"></div>
                  <br>
                     <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Status Lamaran</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="select2_single form-control" name="status_lamaran" tabindex="-1">
                                                <option <?php echo ($this->input->post("status_lamaran")=="diterima")?"selected":"";?> value="diterima">Diterima</option>
                                                <option <?php echo ($this->input->post("status_lamaran")=="tidak diterima")?"selected":"";?> value="tidak diterima">Tidak Diterima</option>
