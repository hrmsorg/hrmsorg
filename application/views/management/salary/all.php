                          ...
                          <div class="x_panel">
                              <div class="x_title">
                                  ...
                                  <div class="col-md col-sm col-xs form-group pull-right top_search">
                                     <a href="<?php echo 'get_salary_add';?>" >  <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Add New"><i class="fa fa-plus" ></i></button></a>
                                  </div>
                                  <div class="clearfix"></div>
                              </div>
                              <div class="x_content">
                                        ...
                                        <?php 
                                          foreach ($salary_all as $key) {
                                            ...
                                            <tr class="even pointer">
                                              ...
                                              <td><?php echo $key['pokok'];?></td>
                                              <td><?php echo $key['tunjangan'];?></td>
                                              <td><?php echo $key['periode_kerja_awal'];?></td>
                                              <td><?php echo $key['periode_kerja_akhir'];?></td>
                                                <td><a href="<?php echo base_url('Salary/salary_delete/'.$key['id']);
                                            ?>" onClick="return doconfirm();">   <button title="" data-placement="bottom" data-toggle="tooltip" data-original-title="Trash" class="btn btn-sm tooltips btn-danger"><i class="fa fa-trash-o"></i>
                                              ...
                                              <a href="<?php echo base_url('salary/salary_edit/'.$key['id']);
