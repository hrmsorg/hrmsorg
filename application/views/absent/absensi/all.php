    ...
    <div class="col-md col-sm col-xs form-group pull-right top_search">
        <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Add New"> <a href="<?php echo 'get_absent_add';?>" ><i class="fa fa-plus" ></i></a></button>
    </div>
</div>
</div>
