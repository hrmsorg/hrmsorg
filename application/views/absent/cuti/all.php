                ...
                <div class="">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="x_panel">
                              <div class="x_title">
                                  <h2>View Cuti <small>All Cuti</small></h2>
                                  <div class="col-md col-sm col-xs form-group pull-right top_search">
                                     <a href="<?php echo 'get_cuti_add';?>" >  <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="Add New"><i class="fa fa-plus" ></i></button></a>
                                  </div>
                                  <div class="clearfix"></div>
                              </div>
                              <div class="x_content">
                                        ...
                                        <?php 
                                          foreach ($cuti_all as $key) {
                                            ...
                                            <tr class="even pointer">
                                              ...
                                              <td><?php echo $key['approved'];?></td>
                                               <td><a href="<?php echo base_url('Cuti/cuti_delete/'.$key['id']);
                                            ?>" onClick="return doconfirm();">   <button title="" data-placement="bottom" data-toggle="tooltip" data-original-title="Trash" class="btn btn-sm tooltips btn-danger"><i class="fa fa-trash-o"></i>
                                              ...
                                              <a href="<?php echo base_url('cuti/cuti_edit/'.$key['id']);
