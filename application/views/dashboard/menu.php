              ...
              <li>
                <a>
                  ...
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li>
                      <a href="<?php echo base_url('Cuti/cuti_all');?>">Cuti</a>
                    </li>
                    <li>
                      <a href="<?php echo base_url('MasterCuti/master_cuti');?>">Master Cuti</a>
                    </li>
                    <li>
                      <a href="<?php echo base_url('Overtime/overtime_all');?>">Overtime</a>
                    </li>
                   </ul>
              </li>
            </ul>
